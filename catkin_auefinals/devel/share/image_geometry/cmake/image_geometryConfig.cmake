...
if("TRUE" STREQUAL "TRUE")
  set(image_geometry_SOURCE_PREFIX /home/drew/SCHOOL/AuE893Spring20_DrewBarnett/catkin_auefinals/src/auefinals/vision_opencv/image_geometry)
  set(image_geometry_DEVEL_PREFIX /home/drew/SCHOOL/AuE893Spring20_DrewBarnett/catkin_auefinals/devel)
  ...
  set(image_geometry_INSTALL_PREFIX /home/drew/SCHOOL/AuE893Spring20_DrewBarnett/catkin_auefinals/install)
...
if(NOT "/home/drew/SCHOOL/AuE893Spring20_DrewBarnett/catkin_auefinals/src/auefinals/vision_opencv/image_geometry/include " STREQUAL " ")
  set(image_geometry_INCLUDE_DIRS "")
  set(_include_dirs "/home/drew/SCHOOL/AuE893Spring20_DrewBarnett/catkin_auefinals/src/auefinals/vision_opencv/image_geometry/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'image_geometry' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/drew/SCHOOL/AuE893Spring20_DrewBarnett/catkin_auefinals/src/auefinals/vision_opencv/image_geometry/${idir}'.  ${_report}")
    endif()
    _list_append_unique(image_geometry_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "image_geometry")
